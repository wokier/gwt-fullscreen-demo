...
public class ToggleFullscreenWithInputActivity implements Activity, View.Presenter, FullscreenChangeEvent.Handler {
	...
	public void toggleFullscreen() {
		if (fullscreen) {
			...
			Fullscreen.requestFullscreen(true);
		}
